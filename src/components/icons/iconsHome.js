export const tymHomeIcon = ({ width = '24', height = '24', className }) => {
    <svg
        className={className}
        width={width}
        height={height}
...
// export const commentHomeIcon = ({ width = '24', height = '24', className }) => {
//     <svg
//         className={className}
//         width={width}
//         height={height}
...
//     </svg>;
// };
// export const shareHomeIcon = ({ width = '24', height = '24', className }) => {
//     <svg
//         className={className}
//         width={width}
//         height={height}
